      ...
      <div className="max-w-content relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display text-white max-w-3xl mx-auto leading-tight">
            Let's make your system the <span className="block mt-2 text-gradient">next success story.</span>
          </h2>
          ...
          >
            Every business featured here started with a simple conversation. 
